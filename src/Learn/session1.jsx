...
const Session1 = () => {
  ...
  useEffect(() => {
    fetch("https://vocab-master-server-27bb9zgej-abir7171.vercel.app/words")
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
          ...
          >
            {lesson.map((less, index) => (
              <SwiperSlide key={index}>
                <div className="grid">
                  <div className="w-full md:w-1/2 mx-auto font-serif space-y-4 grid-cols-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <p>Meaning In Hindi : {less.meaning.hindi}</p>
                    </div>

                    <div className="flex  justify-between items-center">
                      <p>Part of speech : {less.partOfSpeech}</p>
                      <p>
                        Antonyms: {less.antonyms[1]}, {less.antonyms[0]}
                      </p>
                    </div>
