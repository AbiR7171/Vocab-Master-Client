...
const SeasonONeQuiz = () => { 
    ...
    useEffect(()=>{
        ...
        axios.get("https://vocab-master-server-27bb9zgej-abir7171.vercel.app/seasonQuiz")
        .then(res => {
    ...
    const handleCompleted = () =>{ 
              ...
              axios.put(`https://vocab-master-server-27bb9zgej-abir7171.vercel.app/singleUser/firstSeasonMark/${userInfo[0].email}`, {
                  first : marks
              })
              .then(res => {
                  console.log(res.data);
...
<Icon icon="basil:diamond-solid" className="text-4xl text-green-900" /> <p className="text-4xl  text-red-900">{marks}</p>
</div>
            ...
            > 
              ...
              <SwiperSlide>
                       <button onClick={handleCompleted} className='btn  bg-red-700  border-0 px-20 mt-52 ms-[600px]'>Completed</button>
              </SwiperSlide>
