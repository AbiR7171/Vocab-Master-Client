...
const SeasonONeQuiz = () => { 
    ...
    useEffect(()=>{
        ...
        axios.get("https://vocab-master-server-new.vercel.app/seasonQuiz")
        .then(res => {
    ...
    const handleCompleted = () =>{ 
              ...
              axios.put(`https://vocab-master-server-new.vercel.app/singleUser/firstSeasonMark/${userInfo[0].email}`, {
                  first : marks
              })
              .then(res => {
                  console.log(res.data);
