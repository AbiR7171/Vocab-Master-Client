...
const SeasonThree4 = () => {
  ...
  const level = words?.filter((l) => l.level == 3.4);
  ...
  return (
    <div style={backGroundStyle} className=" h-[100vh] bg-black bg-opacity-60">
      <div className=" w-full h-20 ">
        ...
        <div className="flex justify-end  pe-8 bg-black bg-opacity-80 ">
        ...
        <div className="bg-black bg-opacity-80">
          ...
          <div className="h-[calc(100vh-88px)] pt-5 md:pt-20">
            <Swiper
              cssMode={true}
              navigation={true}
              pagination={true}
