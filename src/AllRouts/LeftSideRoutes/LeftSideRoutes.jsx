    ...
    return (
        <div className="drawer lg:drawer-open ">
            ...
            <div className="drawer-content flex flex-col items-center justify-center h-full ">
                ...
                <label htmlFor="my-drawer-2" className="btn bg-transparent border-0 absolute top-2 left-2 drawer-button lg:hidden">
            ...
            <div className="drawer-side z-50">
                ...
                <ul className={`menu p-4 md:p-4 w-60 md:w-80 h-full  fixed  space-y-1 bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 text-white border border-black `}>
