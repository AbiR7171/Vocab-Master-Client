...
const Feedback = () => {
  ...
  const handleIssue = event => {
    ...
    axios.post("https://vocab-master-server.onrender.com/feedback", {
  ...
  return (
    <div className='bg-Backs w-full h-full'>
      ...
      <div className="w-full md:w-4/5 ml-auto flex justify-center items-center min-h-screen">
        <form onSubmit={handleIssue} className="bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 opacity-80 shadow-md rounded w-full md:w-2/5 px-8 pt-6 pb-8 mb-4">
          ...
          <div className="mb-4">
            <label className="block  text-black text-lg font-bold mb-2" htmlFor="issue">
              Feedback
            </label>
            <textarea
