...
const ManageUser = () => {
    ...
    const handleAdmin = user =>{
        ...
        axios.patch(`https://vocab-master-server.onrender.com/singleUser/users/admin/${user._id}`)
        .then(data => {
             console.log(data);
     ...
     const handleDelete = user =>{
        ...
        axios.delete(`https://vocab-master-server.onrender.com/singleUser/users/${user._id}`)
        .then(data =>{
