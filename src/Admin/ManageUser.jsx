...
const ManageUser = () => {
    ...
    const handleAdmin = user =>{
        ...
        axios.patch(`https://vocab-master-server-27bb9zgej-abir7171.vercel.app/singleUser/users/admin/${user._id}`)
        .then(data => {
             console.log(data);
     ...
     const handleDelete = user =>{
        ...
        axios.delete(`https://vocab-master-server-27bb9zgej-abir7171.vercel.app/singleUser/users/${user._id}`)
        .then(data =>{
