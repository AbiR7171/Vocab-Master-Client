...
const ManageFeedback = () => {
     ...
     const handleShow = (id) => {
                  ...
                  axios.patch(`https://vocab-master-server-27bb9zgej-abir7171.vercel.app/feedback/show/${id}`)
                  .then(res => {
                            console.log(res);
    ...
    return (
        ...
        <p className='text-center mt-10 uppercase underline text-4xl text-red-600'>Manage Feedback</p>
                ...
                feedbacks.map(feedback => {
                     return  <div className='bg-gradient-to-r from-red-200 to-red-600 p-2 rounded '>
                           ...
                           <div className='w-full flex justify-end mt-2 me-4'>
                              <button onClick={()=> handleShow(feedback._id)} className='bg-green-700 p-3 rounded'>Show Home</button>
                           </div>
