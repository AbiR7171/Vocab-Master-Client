    ...
    <div className="bg-Backs w-full h-full ">
      ...
      <div className="w-full flex justify-end px-20 text-black">
        <input
          ...
          className="h-14 p-2 rounded-lg border border-red-900 w-full max-w-xs"
        />
        <Icon
          onClick={handleSearch}
          icon="material-symbols:search"
          className="bg-red-800 h-14  w-14 rounded-lg absolute"
        />
      </div>
              ...
              {words.map((word, index) => {
                return (
                  <tr className="text-1xl font-Sec text-black     ">
                    ...
                    <td>
                      <Link to={`/allRouts/editWord/${word._id}`}>
                        <button className="bg-red-700 p-4 rounded-lg text-white">
                          <Icon icon="dashicons:edit-page" />
                        </button>
                      </Link>
                    </td>
                  </tr>
