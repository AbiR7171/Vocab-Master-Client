...
const Footer = () => {
  return (
    <div className='mt-20'>
      ...
      {/* <footer className="footer items-center p-4 bg-gray-200 text-neutral-content">
      ...
      <footer className="footer p-10 bg-slate-500 bg-opacity-50 text-base-content">
        <div>
          <BiHash className='text-4xl'></BiHash>
          <p className='my-2'> <span className='text-2xl font-bold '>𝓥𝓞𝓒𝓐𝓑 𝓜𝓐𝓢𝓣𝓔𝓡</span></p>
      ...
      <footer className="footer footer-center p-4 bg-slate-600 bg-opacity-60 text-base-content">
        <div>
